...
var lexer = function (input) {
    var operator_tokens = [];
    var t_LT = /</;
    operator_tokens.push(t_LT);
    var t_LTE = /<=/;
    operator_tokens.push(t_LTE);
    var t_GT = />/;
    operator_tokens.push(t_GT);
    var t_GTE = />=/;
    operator_tokens.push(t_GTE);
    var t_EQ = /==/;
    operator_tokens.push(t_EQ);
    var t_AND = /&&/;
    operator_tokens.push(t_AND);
    var t_OR = /\|\|/;
    operator_tokens.push(t_OR);
    var t_OR_N = /\|\|\d+$/;
    operator_tokens.push(t_OR_N);
    var t_LBRACE = /\(/;
    operator_tokens.push(t_LBRACE);
    var t_RBRACE = /\)/;
    operator_tokens.push(t_RBRACE);
    var t_PLUS = /\+$/;
    operator_tokens.push(t_PLUS);
    var t_MINUS = /\-$/;
    operator_tokens.push(t_MINUS);
    var t_DIV = /\//;
    operator_tokens.push(t_DIV);
    var t_MUL = /\*/;
    operator_tokens.push(t_MUL);
    var t_PRESENT = /!=-1/;
    operator_tokens.push(t_PRESENT);
    var t_NOTPRESENT = /==-1/;
    operator_tokens.push(t_NOTPRESENT);
    ...
    var addToken = function (type, value) {
        if (t_OR_N.test(type)) {
            // This is for rules with structure like "any K"
